...
export const InitiatorDomainsHint: React.FC<Props> = (props) => {
  const i18n = useI18n();
  return (
    <HintPopover title={i18n["InitiatorDomains"]} contentWidth={450} {...props}>
      ...
      <List.Root>
        ...
        <List.Item>{i18n["hint_InitiatorDomains_note_1"]}</List.Item>
